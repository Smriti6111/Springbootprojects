...
public class AlienController {
    ...
    //it can produce both xml and json format data since we have not given any restriction
    @RequestMapping(path="/aliens",produces={"application/xml"})
    //here we are restricting json and only allowing xml data to be produced in postman for this method
    //if we give application/json in value ,it will show as not acceptable
    @ResponseBody
    ...
    //since we have not added any description for this method we will b able to access both json and xml
    @ResponseBody
